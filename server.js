...
// app.get("/articlesOLD", function(req, res) {
//   // Grab every document in the Articles collection
//   db.Article.find({})
//     .then(function(dbArticle) {
//       // If we were able to successfully find Articles, send them back to the client
...
// app.post("/articlesOLD/:id", function(req, res) {
...
app.post("/articles/:id", async function(req, res) {
  ...
  // db.Article.find({ saved: true }).forEach(function(d){
  //   db.getSiblingDB('News4U')['Saved'].upsert(d);
  // });
});
